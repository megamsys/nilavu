...
describe CategoriesController do
  describe "create" do
    ...
    it "requires the user to be logged in" do
      expect { xhr :post, :create }.to raise_error(Nilavu::NotLoggedIn)
    end
  ...
  describe "destroy" do
    ...
    it "requires the user to be logged in" do
      expect { xhr :delete, :destroy, id: "category"}.to raise_error(Nilavu::NotLoggedIn)
    end
  ...
  describe "update" do
    ...
    it "requires the user to be logged in" do
      expect { xhr :put, :update, id: 'category'}.to raise_error(Nilavu::NotLoggedIn)
    end
  ...
  describe 'update_slug' do
    it 'requires the user to be logged in' do
      expect { xhr :put, :update_slug, category_id: 'category'}.to raise_error(Nilavu::NotLoggedIn)
    end
