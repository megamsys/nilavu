...
describe UsersController do
  ...
  context '.username' do
    it 'raises an error when not logged in' do
      expect { xhr :put, :username, username: 'somename' }.to raise_error(Nilavu::NotLoggedIn)
    end
    ...
    context 'while logged in' do
      ...
      it 'raises an error when change_username fails' do
        ...
        expect { xhr :put, :username, username: user.username, new_username: new_username }.to raise_error(Nilavu::InvalidParameters)
        expect(user.reload.username).to eq(old_username)
      end
  ...
  describe '.pick_avatar' do
    ...
    it 'raises an error when not logged in' do
      ...
      }.to raise_error(Nilavu::NotLoggedIn)
    end
  ...
  describe '.destroy_user_image' do
    ...
    it 'raises an error when not logged in' do
      expect { xhr :delete, :destroy_user_image, type: 'profile_background', username: 'asdf' }.to raise_error(Nilavu::NotLoggedIn)
    end
    ...
    context 'while logged in' do
      ...
      it "only allows certain `types`" do
        expect { xhr :delete, :destroy_user_image, username: user.username, type: 'wat' }.to raise_error(Nilavu::InvalidParameters)
      end
