...
describe SessionController do
  ...
  describe '.sso_login' do
    ...
    before do
      ...
      request.host = Nilavu.current_hostname
    ...
    it 'can take over an account' do
      ...
      logged_on_user = Nilavu.current_user_provider.new(request.env).current_user
    ...
    it 'respects IP restrictions on login' do
      sso = sso_for_ip_specs
      _user = NilavuSingleSignOn.parse(sso.payload).lookup_or_create_user(request.remote_ip)
