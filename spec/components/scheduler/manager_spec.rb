...
describe Scheduler::Manager do
  ...
  let(:manager) { Scheduler::Manager.new(NilavuRedis.new) }
  ...
  describe 'per host jobs' do
    it "correctly schedules on multiple hosts" do
      ...
      hosts.map do |host|
        ...
        manager = Scheduler::Manager.new(NilavuRedis.new, hostname: host)
  ...
  describe '#tick' do
    ...
    it 'should recover from crashed manager' do
      ...
      manager = Scheduler::Manager.new(NilavuRedis.new)
