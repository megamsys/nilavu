class GlobalSetting
  ...
  def self.load_defaults
    default_provider = FileProvider.from(File.expand_path('../../../config/nilavu_defaults.conf', __FILE__))
  ...
  if Rails.env == "test"
    ...
    @provider =
      FileProvider.from(File.expand_path('../../../config/nilavu.yaml', __FILE__)) ||
      EnvProvider.new
  end
