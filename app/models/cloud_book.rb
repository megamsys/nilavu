class CloudBook < ActiveRecord::Base
  ...
  attr_accessible :users_id, :predef_name, :name, :book_type, :predef_cloud_name, :app_defn_ids, :bolt_defn_ids, :domain_name, :cloud_books_history_attributes, :group_name
