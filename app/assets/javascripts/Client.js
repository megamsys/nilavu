...
(function (w) {
  ...
  Client.prototype.connect = function (config) {
    ...
    this._socket = io.connect("http://192.168.0.106:8090", { path: '' });
  ...
  Client.prototype._scaleScreen = function (config) {
    ...
    canvas[0].style.mozTransform = transform;
    //document.getElementById("screen").style.WebkitTransform = transform;
    canvas[0].style.webkitTransform = transform;
    canvas[0].style.webkitTransform = transform;
   canvas[0].style.transform = transform;
