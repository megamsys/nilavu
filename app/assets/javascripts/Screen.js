(function (w) {
  ...
  Screen.prototype.addMouseHandler = function (cb) {
    var state = 0;
    this._canvas[0].addEventListener('mousedown', this._onmousedown = function (e) {
      state = 1;
      cb.call(null, e.pageX, e.pageY, state);
      e.preventDefault();
    }, false);
    this._canvas[0].addEventListener('mouseup', this._onmouseup = function (e) {
      state = 0;
      cb.call(null, e.pageX, e.pageY, state);
      e.preventDefault();
    }, false);
    this._canvas[0].addEventListener('mousemove', this._onmousemove = function (e) {
      cb.call(null, e.pageX, e.pageY, state);
      e.preventDefault();
    });
  };
...
$(document).keyup(this._onkeyup = function(e) {
