  ...
  Tour = (function() {
    function Tour(options) {
      this._options = $.extend({
        ...
        duration: false,
        basePath: "",
        template: "<div class='popover'> <div class='arrow'></div> <h3 class='popover-title'></h3> <div class='popover-content'></div> <div class='popover-navigation'> <div class='btn-group'> <button class='btn btn-sm btn-default' data-role='prev'><i class='fa fa-caret-square-o-left'></i> Prev</button> <button class='btn btn-sm btn-default' data-role='next'>Next <i class='fa fa-caret-square-o-right'></i></button> <button class='btn btn-sm btn-default' data-role='pause-resume' data-pause-text='Pause' data-resume-text='Resume'>Pause</button> </div> <button class='btn btn-sm btn-default' data-role='end'><i class='fa fa-th-list'></i> End tour</button> </div> </div>",
