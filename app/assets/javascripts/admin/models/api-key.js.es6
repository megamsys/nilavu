const ApiKey = Nilavu.Model.extend({
  ...
  **/
  regenerate: function() {
    var self = this;
    return Nilavu.ajax('/admin/api/key', {type: 'PUT', data: {id: this.get('id')}}).then(function (result) {
  ...
  **/
  revoke: function() {
    return Nilavu.ajax('/admin/api/key', {type: 'DELETE', data: {id: this.get('id')}});
  }
...
ApiKey.reopenClass({
  ...
  **/
  find: function() {
    return Nilavu.ajax("/admin/api").then(function(keys) {
  ...
  **/
  generateMasterKey: function() {
    return Nilavu.ajax("/admin/api/key", {type: 'POST'}).then(function (result) {
