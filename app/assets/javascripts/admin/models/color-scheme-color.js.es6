const ColorSchemeColor = Nilavu.Model.extend({
  ...
  // Whether the current value is different than Nilavu's default color scheme.
  overridden: function() {
    return this.get('hex') !== this.get('default_hex');
  }.property('hex', 'default_hex'),

  // Whether the saved value is different than Nilavu's default color scheme.
