const VersionCheck = Nilavu.Model.extend({
  ...
  gitLink: function() {
    return "https://github.com/nilavu/nilavu/tree/" + this.get('installed_sha');
...
VersionCheck.reopenClass({
  find: function() {
    return Nilavu.ajax('/admin/version_check').then(function(json) {
