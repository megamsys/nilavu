Nilavu.LoginMethod = Ember.Object.extend({
  title: function() {
...
//  just Em.get("Nilavu.LoginMethod.all") and then
//  pushObject for any new methods
Nilavu.LoginMethod.reopenClass({
  ...
  all: function(){
    ...
    [ "google_oauth2",
      ...
      if (Nilavu.SiteSettings["enable_" + name + "_logins"]) {
        ...
        methods.pushObject(Nilavu.LoginMethod.create(params));
      }
    });
