...
const UserAction = RestModel.extend({
  ...
  @computed("username")
  sameUser(username) {
    return username === Nilavu.User.currentProp('username');
  },

  @computed("target_username")
  targetUser(targetUsername) {
    return targetUsername === Nilavu.User.currentProp('username');
  },
  ...
  @computed()
  postUrl() {
    return Nilavu.Utilities.postUrl(this.get('slug'), this.get('topic_id'), this.get('post_number'));
  },

  @computed()
  replyUrl() {
    return Nilavu.Utilities.postUrl(this.get('slug'), this.get('topic_id'), this.get('reply_to_post_number'));
  },
