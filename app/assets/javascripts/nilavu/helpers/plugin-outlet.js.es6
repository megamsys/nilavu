/**
   ...
   plugins/hello/assets/javascripts/nilavu/templates/connectors/evil-trout/hello.hbs
   ...
   plugins/hello/assets/javascripts/nilavu/views/connectors/evil-trout/hello.js.es6
...
function findOutlets(collection, callback) {
  ...
  const disabledPlugins = Nilavu.Site.currentProp('disabled_plugins') || [];
