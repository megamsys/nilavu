import { cleanDOM } from 'nilavu/routes/nilavu';
import { startPageTracking, onPageChange } from 'nilavu/lib/page-tracker';
...
export default {
  ...
  initialize(container) {
    ...
    // Out of the box, Nilavu tries to track google analytics
    // if it is present
