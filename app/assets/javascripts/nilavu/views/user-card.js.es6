...
import CleansUp from 'nilavu/mixins/cleans-up';
import afterTransition from 'nilavu/lib/after-transition';
...
export default Ember.View.extend(CleansUp, {
  ...
  addBackground: function() {
    ...
    if (Ember.isEmpty(url)) {
      ...
      $this.css('background-image', "url(" + Nilavu.getURLWithCDN(url) + ")").removeClass('no-bg');
    }
