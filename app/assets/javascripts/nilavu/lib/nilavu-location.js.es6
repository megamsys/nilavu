...
/**
  `Ember.NilavuLocation` implements the location API using the browser's
  `history.pushState` API.

  @class NilavuLocation
  @namespace Nilavu
  @extends Ember.Object
*/
const NilavuLocation = Ember.Object.extend({
  ...
  */
  getURL() {
    ...
    url = url.replace(Nilavu.BaseUri, '');
