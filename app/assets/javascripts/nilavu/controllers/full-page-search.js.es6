import { translateResults, searchContextDescription, getSearchKey, isValidSearchTerm } from "nilavu/lib/search";
...
export default Ember.Controller.extend({
  ...
  noSortQ(q) {
    ...
    return Nilavu.Utilities.escapeExpression(q);
  },
  ...
  search(){
    ...
    const router = Nilavu.__container__.lookup('router:main');
    ...
    Nilavu.ajax("/search", { data: args }).then(results => {
