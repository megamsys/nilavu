      ...
      "topics":[
        {
          ...
          "pinned":false,
          "unpinned":null,
          "excerpt":"...0 lines of Javascript code! An inline example Let's say you want to replace all occurances of \"evil trout\" with a link that says \"EVIL TROUT IS AWESOME\": Nilavu.Dialect.on(\"register\", function(event) {...",
          "visible":true,
          "closed":false,
          "archived":false,
          "bookmarked":null,
        ...
        },
        {
          ...
          "pinned":false,
          "unpinned":null,
          "excerpt":"...plugin that executes the following method to register a new emoji: Nilavu.Dialect.registerEmoji('trout', 'http://cdn.eviltrout.com/images/trout-square.jpg'); Here's a sample plugin that adds a :trout: e...",
          "visible":true,
          "closed":false,
          "archived":false,
          "bookmarked":null,
