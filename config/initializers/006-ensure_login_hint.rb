...
#      "Congratulations, you installed Nilavu! Unfortunately, no administrator emails were defined during setup, so finalizing the configuration <a href='https://meta.Nilavu.org/t/how-to-create-an-administrator-account-after-install/14046'>may be difficult</a>."
#    else
...
#        emails = emails[0]
#      end
#      "Congratulations, you installed Nilavu! Register a new admin account with #{emails} to finalize configuration."
#    end
